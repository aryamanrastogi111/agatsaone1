...
const programmes: Programme[] = [
  ...
  },
  {
    ...
    included: [
      ...
      "Post-meal glucose impact scoring for every meal logged",
      "HbA1c trend prediction (estimated from 30-day glucose patterns)",
    ...
    alert: { type: "red", text: "⚠️ Red Flag Alert: If your fasting glucose stays above 250 mg/dL for 3 consecutive days, or if Nera detects ECG changes alongside a glucose spike, you receive an urgent escalation alert." },
    cta1: { label: "Enrol Now", link: "/app" },
    cta2: { label: "Ask Your Doctor" },
  },
  {
