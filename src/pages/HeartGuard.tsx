...
// 36+ recognitions across national & global stages
const HG_AWARDS_MORE: { name: string; year?: string }[] = [
  ...
  { name: "DPIIT Innovation Award", year: "2022" },
  { name: "BIRAC BIG Grant", year: "2016" },
  { name: "DST NIDHI PRAYAS Grant", year: "2017" },
  { name: "Nidhi Seed Support", year: "2018" },
  { name: "Atal Innovation Mission Recognition", year: "2019" },
  { name: "Smart Fifty by IIM Calcutta", year: "2017" },
  { name: "Anjani Mashelkar Inclusive Innovation", year: "2018" },
  { name: "Lockheed Martin India Innovation Growth", year: "2017" },
  { name: "Tata Social Enterprise Challenge", year: "2017" },
  { name: "TiE Lumis Partners Entrepreneurial Excellence", year: "2018" },
  { name: "NASSCOM Emerge 50", year: "2018" },
  { name: "FICCI Healthcare Excellence", year: "2019" },
  { name: "CII Industrial Innovation Award", year: "2019" },
  { name: "Economic Times Power of Ideas", year: "2017" },
  { name: "Forbes 30 Under 30 (Founder)", year: "2018" },
  { name: "BW Disrupt 40 Under 40", year: "2019" },
  { name: "Cartier Women's Initiative Finalist", year: "2018" },
  { name: "Women Transforming India — NITI Aayog", year: "2019" },
  { name: "Healthcare Innovation Award — AIIMS", year: "2020" },
  { name: "India Health Excellence Award", year: "2021" },
  { name: "Best Medtech Startup — ET Now", year: "2021" },
  { name: "Make in India Champion", year: "2020" },
  { name: "Vibrant Gujarat Innovation Showcase", year: "2019" },
  { name: "Bengaluru Tech Summit Recognition", year: "2018" },
  { name: "Global Bio-India Innovation", year: "2021" },
  { name: "World Health Summit Showcase, Berlin", year: "2019" },
  { name: "GES Hyderabad Featured Startup", year: "2017" },
  { name: "MIT Solve Health Challenge", year: "2019" },
  { name: "Singapore Slingshot Top 100", year: "2019" },
  { name: "Geneva Health Forum Spotlight", year: "2020" },
  { name: "WHO Digital Health Showcase", year: "2021" },
  { name: "Red Herring Asia Top 100", year: "2018" },
  { name: "TechCrunch Disrupt Battlefield", year: "2018" },
];
