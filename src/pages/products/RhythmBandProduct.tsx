      ...
      <section className="py-20 md:py-28 bg-background">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <motion.p {...fadeUp} transition={{ duration: 0.8, delay: 0.15 }} className="mt-6 text-lg text-muted-foreground leading-relaxed">
            Most bands give you 14 charts and a coach subscription. Rhythm Band gives you one Readiness Score — generated by Nera AI from your own baseline, your stress patterns, and what your body did overnight.
          </motion.p>
        </div>
      </section>
