...
const faqs = [
  ...
  { q: "Is the ECG reading as accurate as a hospital ECG?", a: "SanketLife has been clinically validated at 98.15% sensitivity at Sri Jayadeva Institute of Cardiovascular Sciences. While it is not a replacement for a full in-hospital workup, it is the most accurate portable ECG device available for home monitoring in India." },
