          ...
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto gap-6">
            ...
            >
              <Button size="lg" className="bg-teal-600 hover:bg-teal-700 text-white rounded-full px-8 text-base shadow-lg shadow-teal-200" asChild>
                <a href="#buy">
                  Buy Now — ₹2,999 <ArrowRight className="ml-2 h-4 w-4" />
                </a>
              </Button>
        ...
        <div className="container">
          ...
          <AnimatedSection delay={0.2} className="text-center">
            <div className="inline-block bg-card border border-border rounded-2xl p-8 shadow-sm">
              ...
              <p className="text-teal-600 font-medium mb-1">Save ₹2,000 — Launch Offer</p>
        ...
        <div className="container">
          <AnimatedSection className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg mb-8">
              EasyTouch Wellness — ₹2,999. Free shipping. 30-day returns.
            </p>
            <Button size="lg" className="bg-teal-600 hover:bg-teal-700 text-white rounded-full px-10 text-base shadow-lg shadow-teal-200" asChild>
              <a href="#buy">
                Buy EasyTouch Wellness — ₹2,999 <ArrowRight className="ml-2 h-4 w-4" />
              </a>
            </Button>
